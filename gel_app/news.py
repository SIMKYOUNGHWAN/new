...
FEEDS = [
    ...
    ("BM.ge", "https://bm.ge/en/rss"),
    ("Agenda.ge", "https://agenda.ge/en/rss"),
    ("Interpressnews", "https://www.interpressnews.ge/en/rss"),
]

# 제목에 이 중 하나라도 있어야 환율 관련으로 본다.
# 조지아 매체는 대부분 영문 기사를 낸다. 한글 키워드도 함께 둔다.
KEYWORDS = [
    "lari", "GEL", "exchange rate", "currency", "forex",
    "National Bank", "NBG", "monetary", "interest rate", "refinancing",
    "inflation", "remittance", "money transfer", "tourism", "tourist",
    "FDI", "investment", "trade", "export", "import", "reserves",
    "current account", "Geostat", "economy", "GDP",
    "라리", "환율", "조지아",
]
